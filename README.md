[![GoDoc](https://godoc.org/github.com/daniil-kzn/graphql-go-tools?status.svg)](https://godoc.org/github.com/daniil-kzn/graphql-go-tools)
[![CI](https://github.com/daniil-kzn/graphql-go-tools/workflows/ci/badge.svg)](https://github.com/daniil-kzn/graphql-go-tools/workflows/ci/badge.svg)
# graphql-go-tools
...
https://godoc.org/github.com/daniil-kzn/graphql-go-tools
...
```shell script
pkg: github.com/daniil-kzn/graphql-go-tools/pkg/astparser
...
- [Jonas Bergner][jonas-bergner-github]
    ...
    - Implemented Type Extension merging [#108](https://github.com/daniil-kzn/graphql-go-tools/pull/108)
- [Patric Vormstein][patric-vormstein-github] (Active Maintainer)
    - Fixed lexer on windows [#92](https://github.com/daniil-kzn/graphql-go-tools/pull/92)
...
- [Sergey Petrunin][sergey-petrunin-github] (Active Maintainer)
    - Helped cleaning up the API of the pipeline package [#166](https://github.com/daniil-kzn/graphql-go-tools/pull/166)
